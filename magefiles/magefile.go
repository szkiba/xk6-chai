...
func Build() error {
	return shellcmd.Command(`xk6 build --with github.com/szkiba/xk6-chai=.`).Run()
}
...
func License() error {
	...
	return shellcmd.Command(
		`reuse annotate --copyright "Iván Szkiba" --merge-copyrights --license Apache-2.0 --skip-unrecognised ` + all,
	).Run()
}
